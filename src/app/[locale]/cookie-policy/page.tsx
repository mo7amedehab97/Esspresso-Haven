...
export async function generateMetadata(props: ParamsProps) {
  ...
  return buildMetadata(locale, "CookiePolicyMetadata", "cookie-policy");
}

export default function CookiePolicyPage({ params }: ParamsProps) {
          ...
          <div className="p-8 lg:p-12">
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-3">
                {Array.isArray(t.raw("howWeUse.purposes")) &&
                  t
                    .raw("howWeUse.purposes")
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">
                {t("cookieControl.title")}
              </h2>
              <p className="text-gray-700 leading-relaxed mb-6">
                {t("cookieControl.content")}
              </p>
              <div className="bg-amber-50 p-6 rounded-lg border border-amber-200">
                <ul className="space-y-3">
                  {Array.isArray(t.raw("cookieControl.options")) &&
                    t
                      .raw("cookieControl.options")
